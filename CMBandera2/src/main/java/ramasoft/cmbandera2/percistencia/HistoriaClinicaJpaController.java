    ...
    public void create(HistoriaClinica historiaClinica) {
        ...
        try {
            ...
            for (Consulta consultasConsultaToAttach : historiaClinica.getConsultas()) {
                consultasConsultaToAttach = em.getReference(consultasConsultaToAttach.getClass(), consultasConsultaToAttach.getInConsulta());
    ...
    public void edit(HistoriaClinica historiaClinica) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Consulta consultasNewConsultaToAttach : consultasNew) {
                consultasNewConsultaToAttach = em.getReference(consultasNewConsultaToAttach.getClass(), consultasNewConsultaToAttach.getInConsulta());
            ...
            if (msg == null || msg.length() == 0) {
                int id = historiaClinica.getIdHistoriaClinica();
